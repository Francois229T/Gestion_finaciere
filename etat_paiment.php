            ...
            <tbody>";
                ...
                foreach ($participants_data as $participant) {
                    ...
                    $html .= "
                        <tr>
                            ...
                            <td>" . number_format($participant['nb_jours_copies']) .  "</td>
                            <td>" . number_format($participant['taux_journalier_copie']) . "</td>
                ...
                $html .= "
                   <tr class='total-row'>
                    ...
                    <td rowspan='1' class='text-center'><strong>" . number_format($total_general_amount, 0, ',', ' ') . "</strong></td>
